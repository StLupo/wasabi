...
ALARM_LIGHT_ON = os.path.join(BASE_DIR, "cache/alarm_on.png")
ALARM_LIGHT_OFF = os.path.join(BASE_DIR, "cache/alarm_off.png")
ALARM_DELAYED = os.path.join(BASE_DIR, "cache/alarm_blue.png")
